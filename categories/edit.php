        ...
        <form method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea name="description" rows="4"
                    class="w-full bg-slate-900 border border-slate-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-colors"><?php echo htmlspecialchars($category['description']); ?></textarea>
            </div>
